...
const TrailerCard = () => {
  ...
  return (
    <div
      className=" absolute top-0  flex items-center text-white  w-screen bg-gradient-to-r from-[#000000a2]
    z-0
    bg-red
    h-[200px]
    md:h-[450px]
    ...
    >
      <div className="mt-16 w-1/2 md:w-1/4 ml-4 md:mt-10  md:ml-8">
        ...
        <p className="hidden lg:inline-block py-6 text-sm ">{overview}</p>
